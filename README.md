...
`TensorFlow` • `Pandas` • `NumPy` • `Scikit-Learn` • `Keras` • `PyTorch` • `Hugging Face`
...
**[Private & Secure Technical Simplifier](https://github.com/Marik-81/Secure-Technical-Simplifier)** - A local, private RAG system using Ollama and LangChain to translate sensitive technical documents (PDF/Docx) into plain English without data ever leaving the machine

**[Gold-Price-Prediction](https://github.com/Marik-81/Gold-Price-Prediction)** - End-to-end gold price prediction pipeline. Features web scraping, statistical volatility analysis, and machine learning models to forecast market movements.
